    ...
    public class StatusOrdemRepository : IStatusOrdemRepository
    {
        ...
        public void Adicionar(StatusOrdem status)
        {
            ...
            var cmd = new NpgsqlCommand(
                @"INSERT INTO status_ordem (descricao, status)
        ...
        public StatusOrdem? Atualizar(int id, StatusOrdemUpdateDTO status, string? statusquery = null)
        {
            ...
            var descricaoFinal = string.IsNullOrWhiteSpace(status.descricao)
                ? statusExistente.descricao
                : status.descricao;

            var statusFinal = string.IsNullOrWhiteSpace(status.status)
